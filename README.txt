...
See more of Key Features in the official plugin webpage: [Go to the Webpage](https://racmanuel.dev/ar-model-viewer-for-woocommerce/)
...
- **Elementor Widget**: Show 3D Models using a dedicated widget in Elementor.
...
3. **Add 3D Models**: Go to the WooCommerce product edit page and locate the "AR Model Viewer" metabox to upload your .glb (for Android) and .usdz (for iOS) 3D models.
